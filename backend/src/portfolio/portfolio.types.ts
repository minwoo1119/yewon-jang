...
const koData: PortfolioData = {
  ...
  recentResearchTitle:
    '최근 연구 주제와 진행 중인 질문을 홈 화면에서 먼저 보여줍니다.',
  recentResearch: [
    {
      label: 'Current Study',
  ...
  backgroundItems: [
    ...
    },
    {
      ...
      description: '고체역학, 열유체, 재료과학, 공학 설계의 기초를 다졌습니다.',
    },
  ],
  ...
  publications: [
    {
      ...
      role: 'First Author',
      title:
        'Mechanical Reliability Evaluation of Lightweight Composite Structures',
      citation:
    ...
    },
    {
      ...
      role: 'Co-Author',
      title:
        'Effects of Processing Parameters on the Mechanical Properties of Engineered Alloys',
      citation:
